    ...
    <form action="{{ route('tasks.update', $task->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="task_name" id="task_name"
                value="{{ old('task_name', $task->task_name) }}" class="p-2 rounded md outline-black block">
            @error('task_name')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="task_location" id="task_location"
                value="{{ old('task_location', $task->task_location) }}" class="p-2 rounded md outline-black block">
            @error('task_location')
                <div style="color: red;">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="time_complexity" id="time_complexity"
                value="{{ old('time_complexity', $task->time_complexity) }}" min="1" max="5" class="p-2 rounded md outline-black px-3 py-2">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="materials_required" id="materials_required"
                value="{{ old('materials_required', $task->materials_required) }}" class="p-2 rounded md outline-black block">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="deadline" id="deadline"
                value="{{ old('deadline', $task->deadline) }}" class="p-2 rounded md outline-black block">
            @error('deadline')
                <div style="color: red;">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="priority" id="priority"
                value="{{ old('priority', $task->priority) }}" min="1" max="3" class="p-2 rounded md outline-black block">
            @error('priority')
                <div style="color: red;">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="category" id="category"
                value="{{ old('category', $task->category) }}" class="p-2 rounded md outline-black block">
            @error('category')
                <div style="color: red;">{{ $message }}</div>
            @enderror
        </div>
